<template>
  <div>
    ...
    <button @click="clearForm()" class="btn btn-default btn-block">Cancel</button>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-12 col-xs-12 d-flex mb-2" v-for="article in articles" v-bind:key="article.id">
